...
import { IAssetData } from '../interfaces/app-config.inrerface';
import { IGasPrices, IParsedTx } from '../interfaces/gas-price.interface';

import { getChainData, payloadId } from './utilities.utils';
...
export const apiGetCustomRequest = async (chainId: number, customRpc: Partial<IJsonRpcRequest>): Promise<any> => {
