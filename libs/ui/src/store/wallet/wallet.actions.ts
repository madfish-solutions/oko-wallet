...
import { TokenMetadataInput } from '../../interfaces/token-metadata.interface';
...
export const addTokenMetadataAction = createAction<TokenMetadataInput>('wallet/ADD_TOKEN_METADATA');
